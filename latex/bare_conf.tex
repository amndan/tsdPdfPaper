...
\section{Methodology}
\subsection{PDF}
To get an estimation of the actual pose $\widehat{x_t}$ we search for the maximum likelihood of the actual measurement $z_t$ under incorporation of the actual pose $x_t$ and the map data $m$ as follows\todo{ref}:
