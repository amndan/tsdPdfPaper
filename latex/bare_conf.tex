...
\subsection{RNM}
RNM tries to find a rude initial transformation, called pre-transformation in the following, between two consecutive laser scans. This pre-transformation limits the displacements between the scans for the subsequent ICP step.
